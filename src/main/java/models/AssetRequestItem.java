...
public class AssetRequestItem {
    ...
    // Getters and setters
    public Integer getRequestItemId() { return requestItemId; }
    public void setRequestItemId(Integer requestItemId) { this.requestItemId = requestItemId; }
    public AssetRequest getAssetRequest() { return assetRequest; }
    public void setAssetRequest(AssetRequest assetRequest) { this.assetRequest = assetRequest; }
    ...
    public String getConditionOnBorrow() { return conditionOnBorrow; }
    public void setConditionOnBorrow(String conditionOnBorrow) { this.conditionOnBorrow = conditionOnBorrow; }
