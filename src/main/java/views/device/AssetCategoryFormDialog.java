...
public class AssetCategoryFormDialog extends JDialog {
    ...
    private JButton createButton(String text, Color color) {
        JButton b = new JButton(text) {
            ...
            @Override public void updateUI() { super.updateUI(); setContentAreaFilled(false); setOpaque(false);} }
        ;
    ...
    c.setCategoryName(name);
        ...
        try {
            if (category == null) controller.addAssetCategory(c, user); else controller.updateAssetCategory(c, user);
            saved = true;
            dispose();
        } catch (Exception ex) {
