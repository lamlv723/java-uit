...
(2, 'Cấp cao', 'Quản lý', 'manager@company.com', '0901112221', 4, 'Manager', 'manager', '12345', 'Active'),
(3, 'Văn phòng', 'Nhân viên', 'staff@company.com', '0901112222', 4, 'Staff', 'staff', '12345', 'Active'),
...
-- =================================================================
-- PHẦN 3: KHÔNG CÓ DỮ LIỆU YÊU CẦU MƯỢN/TRẢ
-- =================================================================
-- Dữ liệu cho phần này đã được xóa theo yêu cầu.
-- Tất cả tài sản đã được đặt về trạng thái 'Available' (trừ những tài sản 'Retired').
