...
public class UITheme {
    ...
    public static Font fontRegular(float size) { return UIManager.getFont("Label.font").deriveFont(Font.PLAIN, size); }
    public static Font fontMedium(float size) { return UIManager.getFont("Label.font").deriveFont(Font.BOLD, size-1f); }
    public static Font fontBold(float size) { return UIManager.getFont("Label.font").deriveFont(Font.BOLD, size); }
